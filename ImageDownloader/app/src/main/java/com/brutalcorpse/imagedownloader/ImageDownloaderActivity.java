package com.brutalcorpse.imagedownloader;
...
/**
 * Created by brutalcorpse on 05/04/17.
 */

public class ImageDownloaderActivity extends ListActivity {
    @Override
    ...
    private class ObtenerDatos extends AsyncTask<Void, Void, List<String>> {
        ...
        protected void onPostExecute(List<String> strings) {
            setListAdapter(new ArrayAdapter<>(ImageDownloaderActivity.this, R.layout.activity_list, strings));
        }
        @Override
